...
{
    internal class SmileyFace:Emoji
    {


        public SmileyFace (Point center, Point velocity, Color color) :base(center, velocity, color) 
        { 
            Center = center;
            Velocity = velocity;
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawArc(myPen, new Rectangle(Center.X - 30, Center.Y + 5, 60, 50), 0, 180);
        }
